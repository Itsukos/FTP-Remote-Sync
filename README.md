...
|---------|----------|----------|
| v1.1.2 | Windows (desktop + web UI) | [FTPSync_v1.1.2_Windows.zip](https://github.com/Itsukos/FTP-Remote-Sync/releases/latest) |
| v1.1.2 | Docker / Unraid | [FTPSync_v1.1.2_Docker_Unraid.zip](https://github.com/Itsukos/FTP-Remote-Sync/releases/latest) |
